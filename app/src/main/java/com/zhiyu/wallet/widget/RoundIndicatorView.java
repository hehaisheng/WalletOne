...
public class RoundIndicatorView extends View {
    ...
    private String[] text ={"较低","一般","中等","较高","极高"};
    ...
    public void setCurrentNumAnim(int num) {
        float duration = (float)Math.abs(num-currentNum)/maxNum *1500+2000; //根据进度差计算动画时间
    ...
    private void initAttr(AttributeSet attrs) {
        ...
        maxNum = array.getInt(R.styleable.RoundIndicatorView_maxNum,2000);
