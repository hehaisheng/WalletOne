...
public class DashboardView extends View {
    ...
    private int mMin = 800; // 最小值
    private int mMax = 2000; // 最大值
    private int mSection = 20; // 值域（mMax-mMin）等分份数
...
//        canvas.drawText(getFormatTimeStr(), mCenterX, mCenterY + dp2px(70), mPaint);
    ...
    public void setCreditValueWithAnim(int creditValue) {
        ...
        ValueAnimator creditValueAnimator = ValueAnimator.ofInt(800, mSolidCreditValue);
